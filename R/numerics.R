...
assert_is_less_than_or_equal_to <- function(
  ...
  assertive.base::assert_engine(
    is_a_scalar_less_than_or_equal_to, x, y,
    .xname = assertive.base::get_name_in_parent(x),
    severity = severity
  )
}

is_a_scalar_less_than_or_equal_to <- function(x, y,
                                 .xname = assertive.base::get_name_in_parent(x),
...
is_a_scalar_greater_than_or_equal_to <- function(x, y,
                                 .xname = assertive.base::get_name_in_parent(x),
                                 .yname = assertive.base::get_name_in_parent(y)
                                                ) {
  if (!(ok <- is_scalar(x, .xname = .xname)))
...
is_a_non_negative_integer <- function(x,
                                  .xname = assertive.base::get_name_in_parent(x)
                                     ) {
...
is_a_non_positive_integer <- function(x,
                                  .xname = assertive.base::get_name_in_parent(x)
                                      ) {
...
#'
#' @examples
is_a_natural_number <- function(x,
                                .xname = assertive.base::get_name_in_parent(x)
                                ) {
...
is_a_negative_integer <- function(x,
                                  .xname = assertive.base::get_name_in_parent(x)
                                  ) {
